...
function BridalPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden bg-gradient-hero", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 md:grid-cols-2 md:px-6 md:py-24", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: real4, alt: "Sujess bridal makeup — south Indian bride", width: 1024, height: 1280, className: "rounded-3xl object-cover shadow-luxe" })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { eyebrow: "Bridal look", title: "Our Signature Bridal Makeup", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-3xl overflow-hidden rounded-3xl bg-card shadow-luxe", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: real1, alt: "Sujess signature bridal makeup", loading: "lazy", className: "w-full object-cover" }) }) }),
